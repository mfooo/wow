...
{                                                                            /*thread-safe*/
    ...
    /*0x35F*/ { "CMSG_SEARCH_LFG_LEAVE",                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfrSearchOpcode           },
    /*0x360*/ { "SMSG_UPDATE_LFG_LIST",                         STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x361*/ { "SMSG_LFG_PROPOSAL_UPDATE",                     STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x362*/ { "CMSG_LFG_PROPOSAL_RESULT",                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgProposalResultOpcode   },
    /*0x363*/ { "SMSG_LFG_ROLE_CHECK_UPDATE",                   STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x364*/ { "SMSG_LFG_JOIN_RESULT",                         STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x365*/ { "SMSG_LFG_QUEUE_STATUS",                        STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x366*/ { "CMSG_SET_LFG_COMMENT",                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfgCommentOpcode       },
    /*0x367*/ { "SMSG_LFG_UPDATE_PLAYER",                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x368*/ { "SMSG_LFG_UPDATE_PARTY",                        STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x369*/ { "SMSG_LFG_UPDATE_SEARCH",                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x36A*/ { "CMSG_LFG_SET_ROLES",                           STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetRolesOpcode         },
    /*0x36B*/ { "CMSG_LFG_SET_NEEDS",                           STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     },
    /*0x36C*/ { "CMSG_LFG_SET_BOOT_VOTE",                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetBootVoteOpcode      },
    /*0x36D*/ { "SMSG_LFG_BOOT_PLAYER",                         STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x36E*/ { "CMSG_LFD_PLAYER_LOCK_INFO_REQUEST",            STATUS_UNHANDLED,PROCESS_THREADUNSAFE, &WorldSession::HandleLfgPlayerLockInfoRequestOpcode},
    /*0x36F*/ { "SMSG_LFG_PLAYER_INFO",                         STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
    /*0x370*/ { "CMSG_LFG_TELEPORT",                            STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportOpcode         },
    /*0x371*/ { "CMSG_LFD_PARTY_LOCK_INFO_REQUEST",             STATUS_UNHANDLED,PROCESS_THREADUNSAFE, &WorldSession::HandleLfgPartyLockInfoRequestOpcode},
    /*0x372*/ { "SMSG_LFG_PARTY_INFO",                          STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               },
